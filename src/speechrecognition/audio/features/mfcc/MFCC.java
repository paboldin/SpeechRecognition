/**
 *
 * Funf: Open Sensing Framework Copyright (C) 2010-2011 Nadav Aharony, Wei Pan,
 * Alex Pentland. Acknowledgments: Alan Gardner Contact: nadav@media.mit.edu
 *
 * This file is part of Funf.
 *
 * Funf is free software: you can redistribute it and/or modify it under the
 * terms of the GNU Lesser General Public License as published by the Free
 * Software Foundation, either version 3 of the License, or (at your option) any
 * later version.
 *
 * Funf is distributed in the hope that it will be useful, but WITHOUT ANY
 * WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR
 * A PARTICULAR PURPOSE. See the GNU Lesser General Public License for more
 * details.
 *
 * You should have received a copy of the GNU Lesser General Public License
 * along with Funf. If not, see <http://www.gnu.org/licenses/>.
 *
 */
package speechrecognition.audio.features.mfcc;

import java.util.Arrays;

public class MFCC {

    private static double minMelFreq = 130;
    private static double maxMelFreq = 6800;
    ...
    public double[] cepstrum(double[] re, double[] im) {
        ...
        for (int i = 0; i < numCoeffs; i++) {
            ...
            //ceps[i] = melCeps.A[i][0];
        }
        
        //System.out.println(Arrays.toString(ceps));

        return ceps;
    }

    public final static double fmel2hz(double mel) {
        return 700.0 * (Math.pow(10.0, mel / 2595.0) - 1.0);
    }

    public final static double fhz2mel(double freq) {
